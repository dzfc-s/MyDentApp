...
abstract class BaseProvider<T> with ChangeNotifier {
  ...
  // Instance getter (not static) so subclass providers in other files — every custom action
  // beyond plain CRUD (confirm/cancel/markAsRead/etc.) — can reference it unqualified.
