...
/// instead of a dead end. Ported from the desktop admin app's identical
/// helper (used in its "Novi termin"/reschedule dialogs) — mobile's booking
/// screen had no such fallback at all, just a flat "no slots" message with
/// no way forward short of manually flipping through the date picker.
/// Returns null if nothing opens up within [maxDaysToCheck].
